...
#include <afk/common/random.h>
#include <afk/components/Sprite.h>
// #include <afk/components/ui/Image.h>
...
void Menu::start() {
  ...
  createComponent<afk::Sprite>(background, assets.getImage(background_image));
  createComponent<afk::Transform>(background, afk::Vec3(0, 0, 0),
                                  afk::Vec2(800, 600));
  ...
  auto& titleSprite =
      createComponent<afk::Sprite>(title, assets.getImage("title"));
  createComponent<afk::Transform>(title, afk::Vec3(20, 20, 1),
                                  titleSprite.texture.getSize());
